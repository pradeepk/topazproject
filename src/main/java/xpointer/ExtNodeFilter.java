...
/**
 * This class extentds the concept of NodeFilter, providing filtering
 * values for points and ranges.
 */
public class ExtNodeFilter {

    public static final int SHOW_POINT = 9998;
    
    public static final int SHOW_RANGE = 9999;
