	...
	<ul>
		<@ww.url namespace="/static" action="privacy" includeParams="none" id="privacyURL" />
		<li><a href="${privacyURL}" title="PLoS ONE Statement" tabindex="501">Privacy Statement</a></li>
		<@ww.url namespace="/static" action="terms" includeParams="none" id="termsURL" />
		<li><a href="${termsURL}" title="PLoS ONE Terms of Use" tabindex="502">Terms of Use</a></li>
		...
		<li><a href="${siteMapURL}" title="PLoS ONE Site Map" tabindex="506">Site Map</a></li>
