...
<p>Please read about the <a href="license.php" title="Open Access and Creative Commons Attribution License">Creative Commons Attribution License</a> before submitting your paper.</p>


<h2 name="exclusions" id="exclusions">Reviewer and Editor Exclusions</h2>
<p>Upon submission of a manuscript, authors will be asked if they wish to exclude any specific academic editors or reviewers from the peer review of their article. The editorial team will respect these requests so long as this does not interfere with the objective and thorough assessment of the article. See the relevant <a href="reviewer_guidelines.php" title="Reviewer Guidelines">guidelines for reviewers</a> and more information on the <a href="competing.php" title="Competing Interest Policy">policy of PLoS regarding competing interests</a>.</p>
