...
<h1><em>PLoS ONE</em> Editorial and Publishing Policies</h1>
...
<p>Upon submission of a manuscript, authors will be asked if they wish to exclude any specific academic editors or reviewers from the peer review of their article. The editorial team will respect these requests so long as this does not interfere with the objective and thorough assessment of the article. See the relevant <a href="reviewerGuidelines.action" title="PLoS ONE | Reviewer Guidelines">guidelines for reviewers</a> and more information on the <a href="competing.action" title="PLoS ONE | Competing Interest Policy">policy of PLoS regarding competing interests</a>.</p>
...
<p>For reports of epidemiological studies, you should consult the <a href="http://www.strobe-statement.org" title="Strobe-statement.org | STrengthening the Reporting of OBservational studies in Epidemiology">STROBE initiative</a>.</p>
