...
<ol>
 ...
 <li><a href="#presubs">Presubmission Enquiries</a> </li>
...
<h2><a name="editorial" id="editorial"></a>3. Overview of the Editorial Process</h2>
...
<h2><a name="presubs" id="presubs"></a>4. Presubmission Inquiries</h2>
...
<p>Our publication system supports a limited range of formats for text and graphics. Text files can be submitted in only the following formats: Word or RTF. Graphics files can only be submitted in the following formats: EPS or TIFF. </p>
...
<p>Most articles published in <em>PLoS ONE</em> are organized in one of two fashions:</p>
...
<p>The title should be specific to the project, yet concise. It should be comprehensible to readers outside your field. Avoid specialist abbreviations, if possible. Titles should be presented in title case, meaning that all words except for prepositions, articles, and conjunctions should be capitalized. </p>
 ...
 <p>Please also provide a brief "running head" of fewer than 30 characters.</p>

<h3>Authors and Affiliations</h3>
<p>Provide the first names or initials (if used), middle names or initials (if used), surnames, and affiliations&#8212;department, university or organization, city, state/province (if applicable), and country&#8212;for all authors. One of the authors should be designated as the corresponding author. If the article has been submitted on behalf of a consortium, all author names and affiliations should be listed at the end of the article.</p>

<h3>Funding</h3>
<p>This section should describe sources of funding that have supported the work. Please also describe the role of the study sponsor(s), if any, in study design; collection, analysis, and interpretation of data; writing of the paper; and decision to submit it for publication.</p>
...
<h3>Tables</h3>
<p>All tables should have a concise title. Footnotes can be used to explain abbreviations. Citations should be indicated using the same style as outlined above. Tables occupying more than one printed page should be avoided, if possible.</p>

<p>Larger tables can be published as online supporting information.</p> 
<p>Tables should be included in the text file, at the very end of the manuscript. The table title should be no more than one sentence. The rest of the table legend should be placed below the table, above any footnotes.</p>
...
<h3>Reporting Medical Meta-Analyses</h3>
...
<p>Reports of meta-analyses of randomized controlled trials (RCTs) should use the QUOROM statement as a guide (Moher D, Cook DJ, Eastwood S, Olkin I, Rennie D, et al. [1999] Improving the quality of reports of meta-analyses of randomized controlled trials: The QUOROM statement. Lancet 354: 1896&#8211;1900) and include a copy of the <a href="http://www.consort-statement.org/QUOROM.pdf" title="Consort-Statement.org | The QUOROM Statement Checklist (27KB PDF)">QUOROM checklist</a>.</p> 
...
<h2><a name="production" id="production">7. Overview of the Production Process</a></h2>
