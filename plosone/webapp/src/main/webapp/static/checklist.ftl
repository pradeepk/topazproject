...
<ul>
  ...
  <li>Have you used proper PLoS style for the references?</li>
  <li>Have you read through the manuscript carefully so that you are sure there are no typographical or grammatical errors?</li>
</ul>

<h2>Supporting Information Requirements</h2>
<ul>
  <li>Do you have datasets or raw data in a format that can be readily submitted as supporting information?</li>
  <li>Are any new or lesser-known protocols described in detail in a separate file that can be submitted as supporting information?</li>
