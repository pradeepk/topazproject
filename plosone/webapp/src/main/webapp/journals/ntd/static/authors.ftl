...
<h1>For <em>PLoS Neglected Tropical Diseases</em> Authors and Reviewers</h1>
...
<ul>
	<li><@s.a href="${whypublishURL}" title="PLoS NTDS | Why Publish With Us?">Why Publish With Us?</@s.a> - Benefits of publishing your paper in <em>PLoS Neglected Tropical Diseases</em></li>
	...
	<li><@s.a href="${reviewerGuidelinesURL}" title="PLoS NTDS | Reviewer Guidelines ">Reviewer Guidelines</@s.a> - Criteria for publication, the review process, and other guidelines</li>
</ul>
