  ...
  function init(e) {
    ...
    _dcf.formAction = new Array("/annotation/secure/createAnnotationFlagSubmit.action", "/annotation/secure/createReplyFlagSubmit.action", "/rate/secure/createRatingFlagSubmit.action");
