    ...
    // String
	  ...
	  bgColor: "black",
		...
		trapTabs: function(/*Event*/ e){
			...
			//dojo.widget.DialogBase.superclass.trapTabs.apply(this, arguments);
		},
		...
		clearTrap: function(/*Event*/ e) {
			...
			//dojo.widget.DialogBase.superclass.clearTrap.apply(this, arguments);
		},
		...
		postCreate: function() {
			...
			//dojo.widget.DialogBase.superclass.postCreate.apply(this, arguments);
		},
		
		//uninitialize: function() {
		//	dojo.widget.DialogBase.superclass.uninitialize.apply(this, arguments);
		//},
		...
		setBackgroundColor: function(/*String*/ color) {
			...
			//dojo.widget.DialogBase.superclass.setBackgroundColor.apply(this, arguments);
		},
		...
		setBackgroundOpacity: function(/*Number*/ op) {
			...
			//dojo.widget.DialogBase.superclass.setBackgroundOpacity.apply(this, arguments);
		},
		...
		_sizeBackground: function() {
			...
			//dojo.widget.DialogBase.superclass._sizeBackground.apply(this, arguments);
		},
		...
		_showBackground: function() {
			...
			//dojo.widget.DialogBase.superclass._showBackground.apply(this, arguments);
		},
...
*/		},
		...
		showModalDialog: function() {
			...
			//dojo.widget.DialogBase.superclass.showModalDialog.apply(this, arguments);
		},
		...
		hideModalDialog: function(){
			...
			//dojo.widget.DialogBase.superclass.hideModalDialog.apply(this, arguments);
		},
		...
		_onScroll: function(){
			...
			//dojo.widget.DialogBase.superclass._onScroll.apply(this, arguments);
		},
		...
		checkSize: function() {
			...
			//dojo.widget.DialogBase.superclass.checkSize.apply(this, arguments);
		},
		...
		onBackgroundClick: function(){
			...
			//dojo.widget.DialogBase.superclass.onBackgroundClick.apply(this, arguments);
		}
	});
...
dojo.widget.defineWidget(
	...
	[dojo.widget.ContentPane, dojo.widget.Dialog, topaz.widget.RegionalDialogBase],
	{
		// summary
		//	Pops up a modal dialog window, blocking access to the screen and also graying out the screen
		//	Dialog is extended from ContentPane so it supports all the same parameters (href, etc.)
      ...
      //topaz.widget.RegionalDialog.prototype.superclass.setCloseControl.call(this);
		},
