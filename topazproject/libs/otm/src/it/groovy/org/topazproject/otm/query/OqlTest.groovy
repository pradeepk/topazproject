...
public class OqlTest extends GroovyTestCase {
  ...
  void testFilters() {
    ...
    def nameCls = o1.info.name.getClass()
    cls = rdf.class('Test2') {
      state (type:'xsd:int')
      names1 (javaType:nameCls, maxCard:-1, colMapping:'Predicate')
      names2 (javaType:nameCls, maxCard:-1, colMapping:'RdfSeq')
      names3 (javaType:nameCls, maxCard:-1, colMapping:'RdfList')
    }

    def o4 = cls.newInstance(id:"bar:1".toURI(), state:1,
               names1:[nameCls.newInstance(givenName:'Bob', surname:'Cutter'),
                       nameCls.newInstance(givenName:'Jack', surname:'Keller')],
               names2:[nameCls.newInstance(givenName:'Bob', surname:'Cutter'),
                       nameCls.newInstance(givenName:'Jack', surname:'Keller')],
               names3:[nameCls.newInstance(givenName:'Bob', surname:'Cutter'),
                       nameCls.newInstance(givenName:'Jack', surname:'Keller')])
