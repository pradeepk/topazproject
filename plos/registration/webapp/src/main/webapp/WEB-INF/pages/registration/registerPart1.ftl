...
<div id="hdr">
	...
	<ul id="nav">
		...
		<li><a href="#" class="drop">Authors</a>
			<table><tr><td>
				<ul>
...
<h2>Sign up for PLoS One </h2>
  ...
  <fieldset>
		...
		<ol>
      <@s.textfield label="Email " name="loginName1" required="true" tabindex="101" maxlength="256"/>
      <@s.textfield label="Please re-type your email " name="loginName2" required="true" tabindex="102" maxlength="256"/>
      <@s.password label="Password " name="password1" required="true" tabindex="103" maxlength="128"/>
      <@s.password label="Please re-type your password " name="password2" required="true" tabindex="104" maxlength="128"/>
		</ol>
      <@s.submit name="submit" value="Submit" tabindex="105"/>
	</fieldset>
  </@s.form>
