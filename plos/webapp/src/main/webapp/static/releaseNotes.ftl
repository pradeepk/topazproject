...
<div id="content" class="static">
  ...
  <!--p>For more detail on RC 0.8.2, see the <a href="" title="PLoS.org | Topaz Release Candidate 0.8.1">PLoS Blog</a></p-->
  ...
  <!--p>For more detail on RC 0.8.1, see the <a href="" title="PLoS.org | Topaz Release Candidate 0.8.1">PLoS Blog</a></p-->
  ...
  <p>For more detail on RC 0.8, see the <a href="http://www.plos.org/cms/node/260" title="PLoS.org | Topaz Release Candidate 0.8">PLoS Blog</a></p>
  ...
  <ul>
    ...
    <li>Support for note DOIs in the DOI resolver.
    <li>Dynamic "Most Viewed" tab for journal home pages</li>
  </ul>
  ...
  <p>For more detail on RC 0.8.2.1, see the <a href="https://www.plos.org/cms/node/331" title="PLoS.org | Topaz Release Candidate 0.8.2.1">PLoS Blog</a></p>
  ...
  <p>
    For more detail on RC 0.7, see the 
    <a href="http://www.plos.org/cms/node/240" title="PLoS.org | PLoS ONE Release Candidate 0.7">PLoS 
    Blog</a>
  </p>
  ...
  <ul>
    ...
    <li>Article title and "PLoS ONE:" is in title of page now</li>
    <li>Fixed RDF header in <em>PLoS ONE</em> pages</li>
  </ul>
  <p>
    For more detail on RC 0.6, see the 
    <a href="http://www.plos.org/cms/node/220" title="PLoS.org | PLoS ONE Release Candidate 0.6">PLoS 
    Blog</a>
  </p>
</div>
<!-- end : main contents -->
