...
<h1>Site Error</h1>
	...
	<p>If you want to report an error, please provide a detailed account of the circumstances and e-mail <a href="mailto:webmaster@plos.org">webmaster@plos.org</a>.</p>
