...
<h1>Media Inquiries</h1>
				...
				<p class="intro">Media inquiries should be sent to <a href="http://www.plos.org/contact.php?recipient=pre" title="PLoS.org: Contact Form">our contact form</a> or call Natalie Bouaravong (US office), +1 415 568 3445 or Andrew Hyde (UK office) +44 (0) 1223 463 330.</p>

<h2>About the Embargo Policy</h2>
...
<p>
<strong>PLoS believes this embargo policy serves scientists, journalists, and the public by ensuring that the research article is available to all at the time in which it is reported on in the media</strong>. The policy also provides for fair and equal access to our content, ensuring that no one reporter or organization receives preferential treatment or advantage over any other. It also gives the media the opportunity to research and accurately report on scientific articles while ensuring that publicity does not appear before the articles are accessible to the public. And it gives authors the chance to comment on research before it appears in the media. It is likewise designed to give public information officers adequate time to coordinate coverage with scientists at their institutions. 
</p>

<h2>Eligibility to Access Embargoed Materials</h2>

<p>
Journalists and freelancers writing for daily or weekly publications which are registered with <a href="http://www.eurekalert.org" target="_new">EurekAlert</a> or with <a href="http://www.alphagalileo.org/" target="_new">AlphaGalileo</a> are eligible to receive advance, embargoed material from PLoS. Public information officers are eligible to receive advance, embargoed materials from their own institutions only. Eligible individuals must agree to follow the terms of the embargo policy. Individuals who break the embargo policy will be removed from the media release circulation list for a period to be determined by the editors of PLoS, after consultation with its advisory committee.


</p>

<p>
Journalists and PIOs are asked to credit the appropriate journal, such as <em>PLoS Biology</em> or <em>PLoS Medicine</em>, as the source of the information. Supporting materials provided by PLoS, such as graphics and video, are to be properly credited to the appropriate source.
</p>

<h2>Conditions of the PLoS Embargo Policy</h2>

<ul>

<li>Stories or reports on research articles may not be published, broadcast, posted online, or placed in the public domain before the embargo date and time. Precise embargo dates and times will be clearly marked on all advance material.</li>

<li>Advance material is for background research only. Journalists may share embargoed materials only with experts in the field to seek comment, but such materials must be clearly identified as embargoed and must include the embargo date and time. Journalists are responsible for taking all necessary steps to ensure that all third parties honor the embargo.</li>

<li>Public information officers may not distribute embargoed materials in the public domain before the embargo date. However, embargoed materials may be distributed to the media by public information officers one week before the embargo date, using services such as EurekAlert, which has strict policies governing media access to embargoed materials. Such releases must be clearly identified as embargoed and must include the embargo date and time. PIOs are responsible for taking all necessary steps to ensure that all third parties honor the embargo.</li>

<li>Failure to adhere to the embargo policy will result in suspension of privileged access to all embargoed materials from PLoS publications.</li>

</ul>

<h2>A Note to Scientists</h2>
