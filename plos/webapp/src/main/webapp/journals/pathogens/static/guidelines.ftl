...
<p>Our aim is to provide all authors with an efficient, courteous, and constructive editorial process. To achieve its required level of quality, <em>${journal_name}</em> is highly selective in the manuscripts that it publishes; rejections rates are high. To ensure the fairest and most objective decision-making, the editorial process is run as a partnership between the <em>${journal_name}</em> <a href="eic.action">Editor-in-Chief</a>, a Deputy Editor, a team of Section Editors (SEs), and a group of academic experts who act as <a href="edboard.action">Associate Editors</a> (AEs). These individuals are leaders in their fields and represent the full breadth of pathogen-related research.</p>
