...
<li><a href="#other">Interviews, Reviews, and Special Reports</a></li>
<li><a href="#production">Overview of the Production Process</a></li>
<li><a href="#embargoes">Blogs, Wikis, Embargoes, and the Media</a></li>
</ol>

<a name="about"></a>
<h2>1. About <em>PLoS Genetics</em></h2> 
<p>The techniques of genetics and genomics are being applied to a wealth of biological questions and experimental systems. <em>PLoS Genetics</em> reflects the full breadth and interdisciplinary nature of this research by publishing outstanding original contributions in all areas of biology. With immediate free access to all content, <em>PLoS Genetics</em> provides a unique venue for publishing genetics and genomics research, ensuring that authors reach the widest possible audience.</p>

<p><em>PLoS Genetics</em> publishes human studies as well as research on model organisms&mdash;from mice and flies, to plants and bacteria. Topics include (but are not limited to) gene discovery and function, population genetics, genome projects, comparative and functional genomics, genetics of disease and disease models, gene therapy, cancer biology, evolution, gene expression, complex traits, chromosome biology, and epigenetics. <em>PLoS Genetics</em> welcomes research articles that demonstrate a novel methodological advance.</p>
...
<p>To be considered for publication in <em>PLoS Genetics</em>, any given manuscript must satisfy the following criteria:</p>
<ul> 
<li>Originality</li>
<li>High importance to researchers in the field</li>
<li>Broad interest to researchers in genetics and genomics</li>
<li>Rigorous methodology</li>
<li>Substantial evidence for its conclusions</li>
</ul>

<a name="editorial"></a>
<h2>5. Overview of Editorial Process</h2>
<p>Our aim is to provide all authors with an efficient, courteous, and constructive editorial process. To achieve its required level of quality, <em>${journal_name}</em> is highly selective in the manuscripts that it publishes; rejection rates are high. To ensure the fairest and most objective decision-making, the editorial process is run as a partnership between the <em>${journal_name}</em> <a href="eic.action">Editor-in-Chief</a>, a Deputy Editor, a team of Section Editors (SEs), and a group of academic experts who act as <a href="edboard.action">Associate Editors</a> (AEs). These individuals are leaders in their fields and represent the full breadth of genetics and genomics.</p>
 
<p>Submitted manuscripts are first reviewed by the EIC, Deputy Editor, or one of the SEs, who may decide to reject the paper or send it on to an AE for further review. The AE is most often a member of the <em>${journal_name}</em> Editorial Board, but occasionally a guest of the Board is invited to serve in this capacity. The AE evaluates the paper and decides whether it describes a sufficient body of work to support a major advance in a particular field. If so, the paper is sent out for external peer review, at which stage the technical and scientific merits of the work are carefully considered. Once the reviews have been received and considered by the editors, a decision letter to the corresponding author is drafted and sent.</p>
...
<p>When authors are unsure whether their work satisfies the basic requirements for publication in <em>${journal_name}</em>, we are happy to consider presubmission inquiries. If you would like to submit an informal presubmission inquiry to see if a manuscript is appropriate in principle, please login or register for a new account within our <a href="${jms_link}">online submission system</a>, choosing 'Submit Presubmission Inquiry' from the list of Author Tasks. Required for all Presubmission Inquiries are contact information, a cover letter, and an abstract.</p>
 
<p>Responses to these inquiries are normally provided within a few working days. Responses may take longer if consultation between members of the editorial board is required. If you are invited to <a href="${jms_link}">submit your manuscript</a>, we will do our best to provide an expeditious initial assessment of the complete manuscript for suitability and then, if warranted, external peer review.</p>
 
<a name="preparation"></a>
<h2>7. Preparation of Research Manuscripts</h2>
...
<p><a href="http://www.plosgenetics.org/article/info%3Adoi%2F10.1371%2Fjournal.pgen.0030124#special">Complex Seizure Disorder Caused by <em>Brunol4</em> Deficiency in Mice</a></p>
<p><a href="http://www.plosgenetics.org/article/info%3Adoi%2F10.1371%2Fjournal.pgen.0030115#special">Genome-Wide Association Scan Shows Genetic Variants in the <em>FTO</em> Gene Are Associated with Obesity-Related Traits</a></p>
<p><a href="http://www.plosgenetics.org/article/info%3Adoi%2F10.1371%2Fjournal.pgen.0030079#special">A Mutation in the Myostatin Gene Increases Muscle Mass and Enhances Racing Performance in Heterozygote Dogs</a></p>
...
<a name="other"></a>
<h2>9. Interviews, Reviews, and Special Reports</h2> 

<p>In addition to weekly research articles, <em>PLoS Genetics</em> also provides a forum for the publication of articles of broad interest to the genetics and genomics community.
These articles are <strong>by invitation only</strong>; however, we encourage you to send your feedback and ideas to ${email}.
</p>

<h4>Interviews</h4>
<p>Jane Gitschier brings her unique conversational style to an ongoing collection of interviews of interesting people in the world of science and genetics &mdash; from Nicholas Wade to Sir John Sulston, from David Botstein to Shirley Tilghman.</p>

<h4>Reviews</h4>
<p>These succinct, synthetic, well-focused, and engaging mini reviews should appeal to a broad genetics readership. Aim for no more than 2,500 words, 50 references, and two or three display items. The article will include an overview of the existing literature but should focus on the future: where is the field going; what exciting developments are expected?<p>

<p>Because these articles are by invitation only, the topic and scope will have been agreed with an editor. It is advisable to forward on a short summary or draft in advance of the full submission. Mini reviews are peer reviewed externally; if accepted for publication, a publication charge does not apply.</p>

<p>Structure the mini review as follows: Title, Authors, Affiliations, Abstract, Introduction, Main Text (broken into subsections as appropriate), Conclusions, Acknowledgments, References, Figure Legends, and Tables. Please refer to the information above about the specifics of manuscript, figure, and table preparation. Email ${email} if you are in any doubt about how our guidelines for research articles differ from those of mini reviews.</p>

<h4>Special Reports</h4>
<p><em>PLoS Genetics</em> editors occasionally recruit a special report of a conference or meeting. This article should be concise and well written, no longer than 1,500 words, with up to 2 display items. The style should be progressive and punchy, and the author should bring his or her own perspective or a particular theme to the report, engaging readers with a range of professional scientific interests and levels of experience. It should inform and inspire novice readers and experts alike by: identifying the overall purpose of the meeting; synthesizing the focus of the scientific discussion in key presentations; and, most importantly, explaining why this conference or meeting is relevant to and generated excitement in the larger scientific community.</p>
<p>Because these are by invitation only, the scope of the report will have been agreed with an editor. Authors should work closely with the recruiting editor, forwarding a draft for review before the final report is submitted. The report may or may not be subject to external peer review; if accepted for publication, a publication charge does not apply.</p>
<p>Please refer to the information above about the specifics of manuscript, figure, and table preparation and email ${email} if you are in any doubt about how our guidelines for research articles differ from those of special reports.</p>
