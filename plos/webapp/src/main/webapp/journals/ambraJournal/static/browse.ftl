...
<div id="content" class="static">
  ...
  <ul>
    <li><@s.a href="${browseIssueURL}" title="Ambra Journal | Current Issue">Current Issue</@s.a> - Browse the Table of Contents for the most recently published issue</li>
    <li><a href="${archiveURL}">Journal Archive</a> - Browse the Table of Contents of past issues of the journal.</li>
    <li><@s.a href="${browseDateURL}" title="Ambra Journal | Browse by Publication Date">By Publication Date</@s.a> - Browse articles by choosing a specific week or month of publication</li>
    <li><@s.a href="${browseSubURL}" title="Ambra Journal | Browse by Subject">By Subject</@s.a> - Browse articles published in a specific subject area</li>
  </ul>
</div>
<!-- end : main contents -->