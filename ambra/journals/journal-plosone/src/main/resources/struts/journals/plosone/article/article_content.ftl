...
-->
<#-- DocURL is used for the social bookmarking links
  Ultimately I would have preferred to do this in the java class
  instead of formatting it here.  But this template needed to be backwards
  compatible.  Please improve on this at a later date.  -josowski
  ...
  The DOI resolver URL I believe is stored in a config file.  We should
  Change this to use the config setting
 -->
...
<#list journalList as jour>
  ...
  <div id="researchArticle" class="content">
    ...
    <div id="contentHeader">
      <p>Open Access</p>
      <p id="articleType">${articleType.heading} <a href="../static/articleTypes.action#${articleType.code}"><img border=0 src="${freemarker_config.getContext()}/images/button_info.png" alt="Article Information" title="Get more information about this article type."></a></p>
    </div>
    <#if publisher != "">
	...
	<div id="articleMenu">
      ...
      <li>
        ...
        <#-- StumbleUpon -->
        <a href="http://www.stumbleupon.com/submit?url=${docURL?url}" target="_new"><img border=0 src="http://cdn.stumble-upon.com/images/16x16_su_solid.gif" alt="StumbleUpon" title="Add to StumbleUpon"></a>
        <#-- for more info, see http://www.stumbleupon.com/buttons.php -->
        <#-- Facebook -->
        <script>function fbs_click() {u='${docURL}';t='${articleInfoX.title}';window.open('http://www.facebook.com/sharer.php?u='+encodeURIComponent(u)+'&t='+encodeURIComponent(t),'sharer','toolbar=0,status=0,width=626,height=436');return false;}</script><a href="http://www.facebook.com/share.php?u=${docURL?url}" onclick="return fbs_click()"><img src="http://static.ak.fbcdn.net/images/share/facebook_share_icon.gif" alt="Facebook" title="Add to Facebook" /></a>       <!-- for mor info, see http://www.facebook.com/share_partners.php -->
        <#-- Connotea -->
