...
dojo.addOnLoad( function() {
  ...
  var adBanner = dojo.byId("compareNetworksBanner");

  if(adBanner) {
    dojo.byId("compareNetworksBanner").src = 'http://comparenetworks.com/partnerAds/IFrameAd.aspx?adid=0&adtypeid=2&siteid=35&subsiteid=0&pagetypeid=0&pageid=0&subpageid=0';
  }
