...
public class SearchServiceTest {
  ...
  public void testQueryTransformation() throws Exception {
    ...
    runQueryTransformationTest("(protein rna) AND (-genetic)", "select art.id , score0 , score1 , score2 , score3 , score4 , score5 from Article art where (((((((search(art.dublinCore.description, 'protein', score0))  or (search(art.dublinCore.title, 'protein', score1))  or (search(cast(art.representations, TextRepresentation).body, 'protein', score2)) ))  or (((search(art.dublinCore.description, 'rna', score3))  or (search(art.dublinCore.title, 'rna', score4))  or (search(cast(art.representations, TextRepresentation).body, 'rna', score5)) )) )) ) minus ((((search(art.dublinCore.description, 'genetic'))  or (search(art.dublinCore.title, 'genetic'))  or (search(cast(art.representations, TextRepresentation).body, 'genetic')) )) )) ;");
    runQueryTransformationTest("(protein rna) AND (-genetic) AND subject:(Biochemistry \"Cell Biology\")", "select art.id , score0 , score1 , score2 , score3 , score4 , score5 , score6 , score7 , score8 , score9 from Article art where (((((((search(art.dublinCore.description, 'protein', score0))  or (search(art.dublinCore.title, 'protein', score1))  or (search(cast(art.representations, TextRepresentation).body, 'protein', score2)) ))  or (((search(art.dublinCore.description, 'rna', score3))  or (search(art.dublinCore.title, 'rna', score4))  or (search(cast(art.representations, TextRepresentation).body, 'rna', score5)) )) ))  and (((search(art.categories.mainCategory, 'biochemistry', score6) or search(art.categories.subCategory, 'biochemistry', score7))  or (search(art.categories.mainCategory, '\"cell biology\"', score8) or search(art.categories.subCategory, '\"cell biology\"', score9)) )) ) minus ((((search(art.dublinCore.description, 'genetic'))  or (search(art.dublinCore.title, 'genetic'))  or (search(cast(art.representations, TextRepresentation).body, 'genetic')) )) )) ;");
  }
