...
<html>
  ...
  <body>
    ...
    <@s.url namespace="/admin" action="volumeManagement" volumeURI="${volumeURI!''}"
        id="volumeManagement"/>
    <@s.url namespace="/admin" action="issueManagement" issueURI="${issue.id}"
        volumeURI="${volumeURI!''}" id="issueManagement"/>
    <p style="text-align:left">
      ...
      /&nbsp; <@s.a href="${issueManagement}">Issue Management</@s.a>
    </p>
