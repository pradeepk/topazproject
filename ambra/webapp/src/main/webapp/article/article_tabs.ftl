  ...
  <ul id="tabsContainer">
    <#switch tab>
      <#case "article">
        ...
        <li id="related"><@s.a href="${relatedTabURL}" cssClass="tab" title="Related Information">Related Content</@s.a></li>
      ...
      <#case "related">
        ...
        <li id="related" class="active"><@s.a href="${relatedTabURL}" cssClass="tab" title="Related Information">Related Content</@s.a></li>
        <li id="comments"><@s.a href="${commentsTabURL}" cssClass="tab" title="Comments">Comments: ${totalComments}</@s.a></li>
        <#break>
      <#case "comments">
        <li id="article"><@s.a href="${articleTabURL}" cssClass="tab" title="Article">Article</@s.a></li>
