...
<div class="beta">We are still in beta! Help us make the site better and<a href="${feedbackURL}" title="Submit your feedback">report bugs</a>.</div>
<div id="contentHeader">
<p>Open Access</p>
<p id="articleType">${articleType.heading}</p>
</div>
<#if publisher != ""><div id="publisher"><p>${publisher}</p></div></#if>
